...
public class Triangle {
    ...
    public String getType(Triangle triangle) {
       ...
       if (isTriangle(triangle)) {
    	   ...
    	   long[] theContainer=triangle.getBorders();
    	   
          // 判断是否是等边三角形
    	   if (triangle.lborderA == triangle.lborderB&&triangle.lborderA==triangle.lborderC) {
               strType = "Regular";
           }
          
          // 三角形既非三边全部相等，又非全部不等，只能是部分相等即等腰三角形
          else if((theContainer[1]==theContainer[2]&&theContainer[1]!=theContainer[0])||
   			   (theContainer[0]==theContainer[2]&&theContainer[0]!=theContainer[1])||
   			   (theContainer[0]==theContainer[1]&&theContainer[0]!=theContainer[2])){
               strType = "Isoceles";
              }
    	 //判断是否是直角三角形
          else if((theContainer[0]*theContainer[0]+theContainer[1]*theContainer[1]==theContainer[2]*theContainer[2])||
   			   (theContainer[0]*theContainer[0]+theContainer[2]*theContainer[2]==theContainer[1]*theContainer[1])||
   			   (theContainer[2]*theContainer[2]+theContainer[1]*theContainer[1]==theContainer[0]*theContainer[0]))
   	   			{
        	  		strType="rightTriangle";
   	   			}
    	// 判断是否是不等边三角形
